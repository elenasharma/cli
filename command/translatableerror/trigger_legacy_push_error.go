...
Please see http://docs.cloudfoundry.org/devguide/deploy-apps/manifest.html#deprecated-app-manifest-features for details. This feature will be removed in the future.
Using manifest file inheritance.yml
`
